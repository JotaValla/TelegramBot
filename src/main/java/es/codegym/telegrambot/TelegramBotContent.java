...
public class TelegramBotContent {
    public static final String STEP_1_TEXT = """
             *¡BIENVENIDO AL NIVEL UNO!*   
             ...
             Te despiertas y te das cuenta de que eres un gato. Es una buena mañana, pero ¿qué son estos extraños sentimientos? 
             Tu estómago está rugiendo de hambre. No hay comida en el apartamento, excepto en la nevera cerrada. ¿Qué hacer?
